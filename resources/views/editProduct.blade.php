    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('editProductt') }}"  enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-3">
                            <select name="category" id="category" class="form-control" onchange="productEditfun(this.value)">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="productName" type="text" class="form-control @error('email') is-invalid @enderror" name="productName" value={{$pro->productName}} required >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="productVariety" type="text" class="form-control @error('email') is-invalid @enderror" name="productVariety" value={{$pro->productVariety}} required >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="productQuantity" type="text" class="form-control @error('email') is-invalid @enderror" name="productQuantity" value={{$pro->productQuantity}} required >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="productPrice" type="text" class="form-control @error('email') is-invalid @enderror" name="productPrice" value={{$pro->productPrice}} required >
                            </div>
                        </div>
